...
const products = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1675663518218-2238421a3898?auto=format&fit=crop&q=80&w=800',
...
const seedData = async () => {
  try {
    ...
    console.log('Data Seeded Successfully with INR Prices!');
    process.exit();
  } catch (error) {
